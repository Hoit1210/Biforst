...
graph TD
    ...
    subgraph "2. Bifrost Core (지능형 SRE 분석 엔진)"
        ...
        Batch["finops_batch.py<br>(FinOps & Threat 일일 배치)"]:::core
    end
    ...
    subgraph "4. Observability & Notification (시각화 및 알림)"
        Discord["Discord Webhook<br>(AI 리포트 / 승인 요청 / Post-mortem)"]:::ui
        Admin{{"SRE 관리자"}}
    ...
    FastAPI <-->|상황 프롬프트 전송 & AI 분석| Gemini
